<template>
  ...
  <div>
    ...
    <el-dialog title="更改折讓" v-model="dialogpage" width="60%" @close="handleClear" :close-on-click-modal="false">
    <el-form :model="form" label-width="120px" > <!-- 统一標籤寬度 -->
      ...
      <el-select v-model="form.product_name" placeholder="選擇油品" disabled >
            <el-option
              style="width: 300px;"
      ...
      <el-form-item label="折讓">
          <el-input v-model="form.discount_float" style="width: 300px;" @input="validateFloat" ></el-input>
        </el-form-item>
...
methods:{
  async savePass() {
     if (!this.form.customerId||!this.form.product_name||!this.form.discount_float||!this.form.newdate) {
    this.$message({
      message: '欄位不可為空',
      type: 'error'
    });
