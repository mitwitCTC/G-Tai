<template>
  ...
  <div class="page-title">
    <h5
      v-if="
        (this.rowType != '1') & (this.rowType !== '6') & (this.rowType !== '9')
      "
    >
      客戶代號:
      <h4>{{ this.cus_code }}</h4>
      ...
      >
        ...
        <el-row style="margin-bottom: 20px">
          <el-form-item label="簽約業務" v-if="this.salesmenData">
            <el-input
              :value="getEmployeeName(cus_form.contract_sales)"
              readonly
            ></el-input>
          </el-form-item>
    ...
    >
      ...
      >
        ...
        <el-form-item label="帳單寄送方式">
          <el-input
            v-model="bills_form.billing_method"
            :formatter="formatBill"
            readonly
          ></el-input>
        </el-form-item>
      ...
      >
        <el-row style="margin-bottom: 20px">
          ...
          <el-form-item label="刷卡金額">
            <el-input
              v-model="SinopacBank.credit_amount"
              :value="formatCurrency(SinopacBank.credit_amount)"
              readonly
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="永豐手續費%">
            <el-input
              v-model="SinopacBank.credit_percent"
              :value="formatCurrency(SinopacBank.credit_percent)"
              readonly
            ></el-input>
          </el-form-item>
          <el-form-item label="永豐手續費">
            <el-input
              v-model="SinopacBank.handling_fee"
              :value="formatCurrency(SinopacBank.handling_fee)"
              readonly
            ></el-input>
          </el-form-item>
          <el-form-item label="永豐入帳金額">
            <el-input
              v-model="SinopacBank.bank_amount"
              :value="formatCurrency(SinopacBank.bank_amount)"
              readonly
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="系統入帳金額">
            <el-input
              v-model="SinopacBank.amount"
              :value="formatCurrency(SinopacBank.amount)"
              readonly
            ></el-input>
          </el-form-item>
        </el-row>
